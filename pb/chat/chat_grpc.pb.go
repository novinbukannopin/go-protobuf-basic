...
type ChatServiceClient interface {
	...
	// server streaming
	ReceiveMessages(ctx context.Context, in *ReceiveMessageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
	// bidirectional
...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *ReceiveMessageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChatServiceServer interface {
	...
	// server streaming
	ReceiveMessages(*ReceiveMessageRequest, grpc.ServerStreamingServer[ChatMessage]) error
	// bidirectional
...
func (UnimplementedChatServiceServer) ReceiveMessages(*ReceiveMessageRequest, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChatService_ReceiveMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).ReceiveMessages(m, &grpc.GenericServerStream[ReceiveMessageRequest, ChatMessage]{ServerStream: stream})
}
